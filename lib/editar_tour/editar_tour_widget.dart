...
class EditarTourWidget extends StatefulWidget {
  const EditarTourWidget({Key? key}) : super(key: key);

  @override
  _EditarTourWidgetState createState() => _EditarTourWidgetState();
}

class _EditarTourWidgetState extends State<EditarTourWidget> {
